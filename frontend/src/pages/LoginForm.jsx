...
const LoginForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      navigate(
        { pathname: `/userDashboard/${data.userId}` },
      ...
      if (consecutiveAttempts >= 3) {
        toast.error(
          "3 consecutive login attempts. Try again after 30 seconds."
        );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Forgot
          <Link to="/forgotcredentials" state={userIdTitle}>
            {" "}
            UserID?
          </Link>
        </p>
        <p>
          Forgot
          <Link to="/forgotcredentials" state={pswdTitle}>
            {" "}
            Password?
          </Link>
        </p>
